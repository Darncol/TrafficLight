...
// Я заметил странный баг если в xcode выбран такой же айфон как на симуляторе то view на светофоре круглые а если на симуляторе например айфон 15 а в икскоде выбран например 13 pro то почему-то светофор больше не круглый если сбилдить проект
